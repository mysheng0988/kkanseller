...
import com.mysheng.office.kkanseller.chart.components.LimitLine;
...
import com.mysheng.office.kkanseller.chart.utils.DateUtil;
import com.mysheng.office.kkanseller.chart.utils.ViewPortHandler;
import com.mysheng.office.kkanseller.chart.view.LineChartMarkView;
...
//        lineChart.animateX(500);
     ...
     * @param color    曲线颜色
     */
//    public void showLineChart(final List<StepData> dataList, String name, int color) {
//        List<Entry> entries = new ArrayList<>();
//        for (int i = 0; i < dataList.size(); i++) {
//            StepData data = dataList.get(i);
//            /**
//             * 在此可查看 Entry构造方法，可发现 可传入数值 Entry(float x, float y)
//             * 也可传入Drawable， Entry(float x, float y, Drawable icon) 可在XY轴交点 设置Drawable图像展示
//             */
//            Entry entry = new Entry(i,  Integer.parseInt(data.getStep())*1.0f);
//            entries.add(entry);
//        }
//
...
//            @Override
//            public String getFormattedValue(float value, AxisBase axis) {
//                String tradeDate = dataList.get((int) value%dataList.size()).getToday();
//                Log.e("getFormattedValue", "getFormattedValue: "+value );
//                Log.e("getFormattedValue", "getFormattedValue: "+tradeDate );
//                String str= DateUtil.formatDateToMD(tradeDate);
//                Log.e("getFormattedValue", "getFormattedValue: "+str );
