package com.mysheng.office.kkanseller.circleprogress;
...
import com.mysheng.office.kkanseller.circleprogress.utils.Constant;
import com.mysheng.office.kkanseller.circleprogress.utils.MiscUtil;
...
public class CircleProgress extends View {
    ...
    private int[] mGradientColors = {Color.GREEN, Color.YELLOW, 0XFFFA632D,Color.RED};
    //当前进度，[0.0f,1.0f]
...
//        mUnitOffset = mCenterPoint.y + mRadius * mTextOffsetPercentInRadius + getBaselineOffsetFromY(mUnitPaint);
        mHintOffset = mCenterPoint.y - mRadius/2 * mTextOffsetPercentInRadius + getBaselineOffsetFromY(mHintPaint);
        mValueOffset = mCenterPoint.y + mRadius/2 * mTextOffsetPercentInRadius+ getBaselineOffsetFromY(mValuePaint);
        updateArcPaint();
...
//        }
    ...
    private void drawArc(Canvas canvas) {
        ...
        canvas.drawArc(mRectF, +5, currentAngle, false, mArcPaint);
        canvas.restore();
    }
