package com.mysheng.office.kkanseller.imagesWatcher;
...
public class ShapeHintView extends LinearLayout {
    ...
    public Drawable makeFocusDrawable() {
        ...
        dotFocus.setCornerRadius(SizeUtil.dp2px(getContext(), 4));
        dotFocus.setSize(SizeUtil.dp2px(getContext(), 8), SizeUtil.dp2px(getContext(), 8));
        return dotFocus;
    }
    ...
    public Drawable makeNormalDrawable() {
        ...
        dotNormal.setCornerRadius(SizeUtil.dp2px(getContext(), 4));
        dotNormal.setSize(SizeUtil.dp2px(getContext(), 8), SizeUtil.dp2px(getContext(), 8));
        return dotNormal;
    }
}
